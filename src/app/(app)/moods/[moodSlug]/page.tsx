...
export const allMoodStreamPosts: MoodStreamPost[] = [
  ...
  { id: "msp3", content: "Sketching some new character designs today. Feeling super inspired! #create", author: "ArtByLena", moodTags: ["create"], timestamp: new Date(Date.now() - 3600000 * 5), imageUrl: "https://placehold.co/600x400.png", imageAlt: "Sketchbook with character designs", vibes: 72, comments: 8, authorAvatarSrc: "https://placehold.co/40x40.png?text=AL", authorAvatarFallback: "AL", dataAiHintAvatar: "artist design", dataAiHintImage: "sketch art" },
  { id: "msp8", content: "My creative space setup. Where the magic happens! #create", author: "DesignerDesk", moodTags: ["create"], timestamp: new Date(Date.now() - 3600000 * 8), imageUrl: "https://placehold.co/600x380.png", imageAlt: "Designer desk setup", dataAiHintImage: "desk workspace", dataAiHintAvatar: "designer person", vibes: 50 },
  { id: "msp4", content: "Weekend plan: hiking up Mount Vista! Who's explored this trail before? Any tips? #discover 🏞️", author: "TrailBlazerTom", moodTags: ["discover"], timestamp: new Date(Date.now() - 3600000 * 10), vibes: 33, comments: 7, authorAvatarSrc: "https://placehold.co/40x40.png?text=TB", authorAvatarFallback: "TB", dataAiHintAvatar: "hiker nature" },
  { id: "msp9", title: "Farmers Market Haul!", content: "Fresh produce from today's market. So excited to cook with these! #discover", author: "LocalFoodie", moodTags: ["discover", "shop"], timestamp: new Date(Date.now() - 3600000 * 2), imageUrl: "https://placehold.co/600x420.png", imageAlt: "Farmers market produce", vibes: 28, comments: 5, authorAvatarSrc: "https://placehold.co/40x40.png?text=LF", authorAvatarFallback: "LF", dataAiHintAvatar: "foodie person", dataAiHintImage: "market food" },
  { id: "msp10", content: "Community cleanup event this Saturday at 10 AM. Let's make our neighborhood shine! #discover", author: "NeighborhoodWatch", tribeName: "City Volunteers", moodTags: ["discover"], timestamp: new Date(Date.now() - 3600000 * 24), vibes: 55, comments: 10, dataAiHintAvatar: "community group" },
  { id: "msp11", title: "Best 50% Off Deals This Week", content: "Found some amazing discounts on electronics and fashion. Check out the link in bio! #shop", author: "DealHunter", moodTags: ["shop"], timestamp: new Date(Date.now() - 3600000 * 4), vibes: 88, comments: 22, authorAvatarSrc: "https://placehold.co/40x40.png?text=DH", authorAvatarFallback: "DH", dataAiHintAvatar: "shopper person" },
  { id: "msp12", content: "New sneaker drop alert! These are going to sell out fast. 👟 #shop", author: "SneakerHead", moodTags: ["shop"], timestamp: new Date(Date.now() - 3600000 * 6), imageUrl: "https://placehold.co/600x370.png", imageAlt: "New sneakers", vibes: 115, comments: 30, authorAvatarSrc: "https://placehold.co/40x40.png?text=SH", authorAvatarFallback: "SH", dataAiHintAvatar: "fashion person", dataAiHintImage: "sneakers shoes" },
  { id: "msp5", content: "Just unboxed the new Pixel 9! First impressions are 🔥. AMA! #learn #discover", author: "GadgetGuru", moodTags: ["learn", "discover"], timestamp: new Date(Date.now() - 3600000 * 12), imageUrl: "https://placehold.co/600x350.png", imageAlt: "New Pixel 9 phone unboxing", vibes: 102, comments: 25, authorAvatarSrc: "https://placehold.co/40x40.png?text=GG", authorAvatarFallback: "GG", dataAiHintAvatar: "tech reviewer", dataAiHintImage: "phone gadget" },
  { id: "new_learn1", title: "Deep Dive into Quantum Computing", content: "Exploring the fundamentals of quantum bits and their potential. #learn", author: "ScienceGeek", moodTags: ["learn"], timestamp: new Date(Date.now() - 3600000 * 7), vibes: 67, comments: 11, dataAiHintAvatar: "scientist person" },
