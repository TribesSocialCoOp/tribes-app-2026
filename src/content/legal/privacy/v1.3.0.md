...
### 1.9 Age Verification & Adult (NSFW) Content

Per our community-adopted Adult Content policy, some tribes are designated 18+ ("NSFW Tribes"). **NSFW Tribes operate in a Private, end-to-end-encrypted state. The platform has zero knowledge of internal content**, and no automated scanning is performed on that encrypted content (see §1.6–1.7).

Accessing NSFW features requires **privacy-preserving age verification**, and we hold a hard line on what we will and will not collect:

- **We never receive your identity.** Where age verification is required, it is performed through a **privacy-preserving third-party method** — your device's digital wallet (currently Google Wallet). **The platform receives only a pass/fail (over-18) attestation** — never your name, birthdate, photo, or any identity document.
- **No government IDs, ever.** **The platform does not collect, store, or transmit government-issued identity documents for any purpose.** If any jurisdiction ever requires government ID as the *only* acceptable method, we will geo-block NSFW content in that jurisdiction rather than comply.
- **What we store is minimal.** To remember that you are eligible, we store only a timestamp that your age was verified and the verification method used (e.g., "google_wallet"), and/or a timestamp recording your self-attested adult-content opt-in. No identity information is stored, and verification is **once per account** — you are not asked again.
- **How your region is determined.** To apply the correct age-gate rules for your location, your IP address is resolved to a coarse region (e.g., country or US state) using a **local database on our own servers**. Your IP is **never sent to any third-party geolocation service**, and **neither your IP nor the resolved region is stored** — both are read for the request and immediately discarded.
- **Display preference.** You may choose to blur adult media by default; this is a local display preference stored with your account.
...
- **Age-gating:** Apply adult-content (18+) rules where required, using the minimal verification data described in §1.9.
...
| **Google Wallet** | Age verification (optional; NSFW only) | A signed verification request; we receive only a pass/fail over-18 result — no identity data is shared to us or by us |
...
Tribes.app is not intended for children under 13 years of age. We do not knowingly collect personal information from children under 13. Adult (NSFW) content and tribes are strictly limited to users verified as 18 years or older. If you are a parent or guardian and believe your child has provided us with personal information, please contact us and we will delete it promptly.
...
- Age verification at signup (13+ minimum); privacy-preserving 18+ verification for adult content
