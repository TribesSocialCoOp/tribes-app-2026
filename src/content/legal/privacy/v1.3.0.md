...
- **We never receive your identity.** Where age verification is required, it is performed through a **privacy-preserving third-party method** — your device's digital wallet (Google Wallet or Apple Wallet). **The platform receives only a pass/fail (over-18) attestation** — never your name, birthdate, photo, or any identity document.
...
| **Google / Apple Wallet** | Age verification (optional; NSFW only) | A signed verification request; we receive only a pass/fail over-18 result — no identity data is shared to us or by us |
